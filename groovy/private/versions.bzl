...
# `groovy.toolchain(version = "2.5.23")`. The cascade in `SPOCK_FOR_GROOVY`
# below picks the matching `spock-core:2.3-groovy-4.0` jar automatically;
# the implicit `groovy.testing(junit = "4")` default keeps JUnit at 4.13.2.
